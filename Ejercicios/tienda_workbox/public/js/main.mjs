...
window.addEventListener('online', () => {
    ...
    // Eliminar el div de aviso si existe
...
window.addEventListener('offline', () => {
    // Lógica cuando estamos offline
    console.log('Estás offline');
    // Mostrar un mensaje de aviso
    const offlineDiv = document.createElement('div');
    const header = document.querySelector('header');
    offlineDiv.id = 'offline';
    offlineDiv.textContent = 'Estás offline';
    header.insertBefore(offlineDiv, header.firstChild);
});